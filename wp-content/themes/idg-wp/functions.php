...
function create_jumbotron_carousel ( $args ) {
...
function get_jumbotron_carousel(  ){
	ob_start();
	...
	create_jumbotron_carousel ( $args );

	$data = ob_get_clean();
	wp_send_json_success( $data );
}
add_action( 'wp_ajax_get_jumbotron_carousel', 'get_jumbotron_carousel' );
add_action( 'wp_ajax_nopriv_get_jumbotron_carousel', 'get_jumbotron_carousel' );
