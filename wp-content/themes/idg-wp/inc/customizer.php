<?php
/**
 * Identidade Digital do Governo - WordPress Theme Customizer
 *
...
function idg_wp_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'idg_wp_customize_partial_blogname',
		) );
 ...
 * @return void
 */
function idg_wp_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function idg_wp_customize_partial_blogdescription() {
